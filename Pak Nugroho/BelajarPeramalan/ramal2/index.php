...
<body>
    ...
    <form action="" method="post">
        <div class="barissatu">
            ...
            <h3>Tahun = </h3>
            <input type="number" name="t<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="style.css">
...
<body>
    ...
    <form action="" method="post">
        ...
        <?php
            ...
            else if($tahunb<0 || ($bulanb<=1 && $tahunb<=0)){
    ...
    <div class="barislima">
        <?php
            for($i=0; $i<$n; $i++){
                if($n == 1){
                    $Un = $nilaipertama + $b;
                    echo "<h4> Prediksi Nilai pada Bulan " , BulanSwitch($bulanprediksi), " Tahun $tahunprediksi adalah $Un </h4>";
                } else if ($n>1){
